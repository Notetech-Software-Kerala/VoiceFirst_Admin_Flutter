...
class ProgramActionService {
  ...
  Future<ProgramActionModel> create(String name) async {
    final url = Uri.parse('$_baseUrl/program-action');
  ...
  Future<ProgramActionModel> updateAction(
    ...
    final url = Uri.parse('$_baseUrl/program-action/$id');
  ...
  Future<void> recover(int id) async {
    final url = Uri.parse('$_baseUrl/program-action/recover/$id');
  ...
  Future<void> bulkDelete(List<int> ids) async {
    final url = Uri.parse('$_baseUrl/program-action/bulk-delete');
