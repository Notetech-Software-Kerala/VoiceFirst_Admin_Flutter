...
class CharacterTypeService {
  ...
  Future<IssueCharacterTypeModel> createCharacterType(String name) async {
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      ...
      throw Exception('Failed to create issue character type');
    }
  ...
  Future<PaginatedResponse<IssueCharacterTypeModel>> getAll(
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      ...
      throw Exception(
        'Failed to load issue character types: ${response.statusCode}',
      );
    }
  ...
  Future<IssueCharacterTypeModel> getById(int id) async {
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      ...
      throw Exception(
        'Failed to load issue character type: ${response.statusCode}',
      );
    }
  ...
  Future<IssueCharacterTypeModel> updateCharacterType({
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      ...
      throw Exception('Failed to update issue character type');
    }
  ...
  Future<IssueCharacterTypeModel> deleteCharacterType(int id) async {
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      ...
      throw Exception('Failed to delete issue character type');
    }
  ...
  Future<IssueCharacterTypeModel> recoverCharacterType(int id) async {
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      ...
      throw Exception('Failed to recover issue character type');
    }
